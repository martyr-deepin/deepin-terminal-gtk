# Deepin Terminal |deepin-terminal.svg|
## Overview |overview.svg|
Deepin Terminal can freely split window according to users requirements with horizontal and vertical screen split supported. It allows users to do terminal settings of fonts and colors changing, background pictures customization, transparency adjustment and so on. You can input various operation commands in the terminal window by keyboard. 

 ![0|interface](interface.png)

## Guide |guide.svg|
### Run Deepin Terminal ###
You can run Deepin Terminal by executing one of the following operations:

- Click on ![terminal_icon](terminal_icon-24.svg) on launcher.
- Right click > **Open in terminal** on desktop.
- Press ![ctrl](Ctrl.svg)+![alt](Alt.svg)+![T](T.svg) to open the terminal interface.

### Minimize Deepin Terminal ###

1. Open Deepin Terminal in launcher interface.
2. Click on ![mini_icon](mini_icon.svg) on Deepin Terminal interface to minimize to Dock.
3. If you want to restore normal display, click on ![terminal_icon](terminal_icon-24.svg) on Dock.

### Maximize Deepin terminal ###

1. Open Deepin Terminal in launcher interface.
2. Click on ![max_icon](max_icon.svg) on Deepin Terminal interface to maximize Deepin Terminal window.
3. If you want to restore normal display, click on ![unmax_icon](unmax_icon.svg) on Dock.

### Close Deepin Terminal ###
#### Click the "Close" button to exit Deepin Terminal ####

1. Open Deepin Terminal in launcher interface.
2. On Deepin Terminal interface, click on ![close_icon](close_icon.svg) to exit Deepin Terminal.

#### Exit Deepin Terminal from Dock ####

1. Open Deepin Terminal in launcher interface.
2. Right-click on![terminal_icon](terminal_icon-24.svg) on Dock.
3. Click on **Close all**.

#### Exit Deepin Terminal from Main Menu ####

1. Open Deepin Terminal in launcher interface.
2. On Deepin Terminal interface, click on ![openset_icon](openset_icon.svg)。
3. Click on **Exit**.

## Common Operations |commonoperation.svg|
You can right-click on Deepin Terminal interface to do daily operations. 

 ![0|rightclick](rightclick.png)
...
5. Please click on ![close_icon](close_icon.svg) at the back of search box if you want to exit search.
...
2. Right-click on Deepin Terminal interface.
3. Click on **Paste** to copy commands to execute in terminal.
...
5. Click on **Copy** to copy commands to anywhere else.

### Open Current Directory ###
When you are operating in Deepin Terminal interface, you can quickly locate and open the directory of current operation.

1. Open Deepin Terminal in launcher interface.
2. Right-click on Deepin Terminal interface.
3. Click on **Open current directory** to open the the directory of command executed in the terminal window.
...
It will do more for less for your subsequent operations to view the shortcuts settings before inputting the command.

 ![1|showshortcutkey](showshortcutkey.png)

#### Key Operation ####

1. Open Deepin Terminal in launcher interface.
2. Press ![ctrl](Ctrl.svg)+![shift](Shift.svg)+![?](？.svg) to open shortcuts preview interface.

#### Interface Operation ####

1. On Deepin Terminal interface, right-click or click on ![openset_icon](openset_icon.svg) in the top right corner.
...
- Press ![Esc](Esc.svg) on keyboard to exit. 
- Click the mouse at anywhere of shortcuts preview interface to exit.
...
> **Attention:** If you need to change the shortcuts, specific operations refer to [Hotkeys Settings](#Hotkeys Settings).

## Window Operations |windowoperation.svg|
### New Terminal Window ###

 ![1|newwindows](newwindows.png)
...
> **Attention:** You also can press ![F4](F4.svg) to open the terminal quake window.
...
3. You can input commands in each terminal window, and can also view the results of command executed.
 ...
 ![0|splitscreen](splitscreen.png)

> **Attention:** You also can press ![ctrl](Ctrl.svg)+![shift](Shift.svg)+![H](H.svg) on keyboard to split vertically, and press ![ctrl](Ctrl.svg)+![H](H.svg) to split horizontally.

### Display Terminal Window in Fullscreen ###

1. Open Deepin Terminal in launcher interface.
2. Press ![F11](F11.svg) to display Deepin Terminal in fullscreen.
3. If you want to restore the normal display, please press ![F11](F11.svg).

> **Attention:** You can also right-click to select **Fullscreen** or **Exit fullscreen** on Deepin Terminal interface.
...
2. Right-click, you can:
 ...
 ![0|closesplitscreen](closesplitscreen.png)

## Workspace Operations |workspaceoperation.svg|
### New Workspace ###
...
3. Click on **Switch workspace**, all the workspaces will be horizontally arranged in the form of preview window below the interface, you can:
 ...
 - Move the mouse pointer over the preview window of workspace, click on ![close_icon](close_icon.svg) to close the workspace.
 - Click on ![plus_icon](plus_icon.svg) to create a new workspace.

 ![0|workspace](workspace.png)

> **Attention:** You can also switch workspaces by clicking on the digital serial number in lower left corner of terminal interface.
...
## SSH Connection |sshconnection.svg|
You can directly input the SSH connection command in terminal window to connect to specified server address. You can also establish SSH remote connection by executing the following operations.
 ...
 ![0|sshconnection](sshconnection.png)

1. Open Deepin Terminal in launcher interface.
2. On Deepin Terminal interface, click on ![openset_icon](openset_icon.svg) in the top right corner.
...
### General ###
 ...
 ![0|generalset](generalset.png)

1. Open Deepin Terminal in launcher interface.
2. On Deepin Terminal interface, right-click or click on ![openset_icon](openset_icon.svg) in the top right corner.
...
4. In the interface of **Hotkeys**, you can:
 ...
 - Please press ![Backspace](Backspace.svg) if you want to disable the shortcut.
 - Please click on **Reset** if you want to restore the default settings.

### Advanced Settings ###

 ![0|advancedset](advancedset.png)
...
4. In the interface of **Advanced**, you can:
 - Set cursor shapes.
 - Enable or disable currsor blink.
