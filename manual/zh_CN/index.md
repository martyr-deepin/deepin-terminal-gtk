...
![tips](icon/tips.svg)：搜索时按下键盘上的 ![Enter](icon/Enter.svg) 键是从当前位置向上搜索，您也可以通过点击搜索界面上的 ![up](icon/up.svg) 或 ![down](icon/down.svg)  图标 来向上搜索或向下搜索。
...
您可以在多个工作区之间任意切换，您可以通过如下方法来选择工作区：
 ...
 - 按下键盘上的 ![Ctrl](icon/Ctrl.svg) + 1~9数字键来选择对应的工作区，当工作区大于9时， 将选中最后一个工作区而不是第9个工作区。
